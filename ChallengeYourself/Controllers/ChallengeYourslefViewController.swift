...
//  ChallengeYourself
//
//  Created by Asliddin Asliev on 10/31/19.
...
class ChallengeYourselfViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = itemArray[indexPath.row].nameOfTheChallenge
...
//        itemArray.remove(at: indexPath.row)
    ...
    @IBAction func addNewChallenge(_ sender: UIBarButtonItem) {
        ...
        let action = UIAlertAction(title: "Add Challenge", style: .default) { (action) in
            ...
            newChallenge.nameOfTheChallenge = textField.text!
...
extension ChallengeYourselfViewController: UISearchBarDelegate
{
